        ...
        <ScrollReveal>
          <div className="mb-12 flex justify-between items-end">
            <div>
              ...
              <h2 className="font-serif text-3xl md:text-4xl text-[#F8F8E8]">Featured Products</h2>
            </div>
          ...
          {featuredProducts.map((product) => (
            <div key={product.id} className="flex flex-col group">
              <Link to={`/product/${product.slug}`} className="block relative aspect-[4/5] rounded-xl overflow-hidden mb-4">
                <div className="absolute inset-0 bg-gradient-to-br from-[#486838]/25 to-transparent flex items-center justify-center">
